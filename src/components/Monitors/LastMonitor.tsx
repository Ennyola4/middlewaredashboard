            ...
            <div className="flex flex-col lg:flex-row gap-4 w-full">
                ...
                <div className="w-full lg:w-1/2 space-y-4 p-4 sm:p-6 rounded-md  dark:bg-gray-800 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex bg-green-500/80 px-2 shadow-lg py-1 rounded-md items-center gap-1">
                            <TrendingUp className="h-4 w-4 text-white dark:text-green-400" />
                            <p className="text-sm text-white text-[12px] dark:text-gray-300">+42.8B vol</p>
                        </div>
                    </div>
                    ...
                    <div className="max-h-[400px] overflow-y-auto pr-2">
                        {transactionMonitor.map((transaction, index) => (
                            <div
                                ...
                                className="bg-white dark:bg-gray-700 p-3 sm:p-4 rounded-lg shadow border-l-4 border-blue-400 mb-3"
                            >
                                <div className="flex justify-between items-center mb-2">
                                    <div className="flex items-center gap-2">
                                        <span className="text-xs sm:text-sm font-medium px-2 py-1 bg-gray-200 shadow-sm rounded-md text-gray-700 dark:text-gray-400 dark:bg-gray-600">
                                            {transaction.id}
                                        </span>
                                        <span className={`px-2 py-1 text-[10px] sm:text-xs rounded-full ${transaction.status.trim() === 'success'
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className={`px-2 py-1 text-[10px] sm:text-xs rounded-full ${parseFloat(transaction.risk) > 50
                                            ? 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'
                ...
                <div className="w-full lg:w-1/2 space-y-4 p-4 sm:p-6 rounded-xl  dark:bg-gray-800 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            <p className="text-[12px] border-[0.5px] rounded-md text-blue-600 shadow-2xl px-2 py-1 dark:text-blue-400">
                                3 Pendings
                            </p>
                        </div>
                    </div>
