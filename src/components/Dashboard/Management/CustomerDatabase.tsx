        ...
        <div>
            <div className="shadow-sm rounded-md m-2 sm:m-3 md:m-5 p-3 sm:p-4 md:p-5 dark:bg-gray-900">
                ...
                <div className=" mb-3 gap-3  sm:p-3">
                    ...
                    {/* Action Buttons */}
                    <div className="flex flex-wrap xs:flex-nowrap gap-2 sm:gap-3 w-fit p-2 rounded-md  xs:w-auto ">
                        ...
                        {/* Filter Button */}
                        <button className="flex cursor-pointer items-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg transition-colors duration-200 text-xs sm:text-sm font-bold">
                            <Filter className="h-4 w-4" />
                            <span className="lg:inline hidden ">Filter</span>
                        </button>

                        {/* Add Customer Button */}
                        <button className="flex cursor-pointer items-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-800/40 text-blue-700 dark:text-blue-300 rounded-lg transition-colors duration-200 text-xs sm:text-sm font-medium">
                ...
                {customerDatabase.map((user, index) => (
                    <div key={index} className="shadow-sm rounded-md dark:bg-gray-950 p-3 mb-3 flex flex-col md:flex-row justify-between items-start md:items-center">
                        ...
                        <div className="flex gap-2 sm:gap-3 p-2 sm:p-3 w-full md:w-auto justify-end md:justify-start">
                            <button className="bg-gray-500 text-white rounded-md p-1 sm:p-2 cursor-pointer hover:bg-gray-800 transition-all duration-700">
