import { securityOverviewSummaryCard } from "../../../utils"

const SecurityOverviewSummaryCard = () => {
  return (
     <div>
       <div className="grid grid-cols-1 dark:bg-black bg-white sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 p-3 sm:p-4 mb-5">
         {securityOverviewSummaryCard.map((item, index) => (
           <div
             key={index}
...
export default SecurityOverviewSummaryCard
